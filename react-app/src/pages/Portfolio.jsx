  ...
  return (
    <div className='w-full h-full'>
      ...
      <PortfolioItem className='flex-auto' name='School Website' image={newport}/>
        ...
        <a href='https://github.com/SalvadorBanuelos424/React_CV'  ><FaGithub className='text-6xl m-4 hover:text-sky-400'/></a>
        <a  href='https://salvadorbanuelos424.github.io/React_CV/'  ><FaLink className='text-6xl m-4 hover:text-sky-400 '/></a>
        </h1>
